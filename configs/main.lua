...
Config.keys = {
    ...
    stow        = 0x827E9EE8, -- [B] Stow Anything
    checkStow   = 0x5415BE48, -- [G] Check Stowed Animals/Corpse/Pelts
}
-----------------------------------------------------
...
Config.tagDistance = 5 -- Default: 15 / Distance from Wagon to Show Tag
-----------------------------------------------------
